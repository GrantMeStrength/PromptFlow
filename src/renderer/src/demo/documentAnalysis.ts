  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        kind: 'ui',
        uiKind: 'text',
        uiLabel: 'Document Text',
        uiPlaceholder: 'Paste your document here…',
        description:
          'Text input — paste any document here. When you click Run, a prompt appears to enter the text. The value is passed downstream as `value`, which all function nodes can access via `inputs.text` or `inputs.value`.',
        inputs: [],
        outputs: [{ name: 'value', type: 'string', description: 'The raw document text' }],
        code: '',
        prompt: '',
      },
    },
