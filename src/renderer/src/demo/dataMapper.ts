...
return { table, processedCount: rows.length }`,
    ...
    },
    {
      ...
      data: {
        ...
        code: '',
        prompt: '',
        noteText: 'The Split node converts the raw list into an array. The LLM processes the whole batch in one call — more efficient than one call per item for small lists.',
      },
    },
  ],
  edges: [
