...
return { __html: html }`,
    ...
    },
    {
      ...
      data: {
        ...
        code: '',
        prompt: '',
        noteText: '📄 This demo shows how PromptFlow can generate a fully styled HTML report from a single topic prompt. The LLM generates structured content (headings, key findings, a data table), the Render Report function node wraps it in styled HTML with a header and colour theme, and the output panel renders it in-place. Use the HTML or PDF buttons in the output panel to save and share the result. To customise: change the topic, or edit the CSS in the Render Report node to match your brand colours.',
      },
    },
  ],
  edges: [
